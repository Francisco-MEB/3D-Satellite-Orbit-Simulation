...
int main(int argc, char *argv[])
{
    ...
    Shader lightingShader { "../include/shaders/3.3.shader.vs", "../include/shaders/3.3.shader.fs" };
    Shader lightCubeShader { "../include/shaders/3.3.light.vs", "../include/shaders/3.3.light.fs" };
