...
int main(int argc, char *argv[])
{
    ...
    GLFWwindow *window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Container", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader ourShader { "../include/shaders/3.3.shader.vs", "../include/shaders/3.3.shader.fs" };
